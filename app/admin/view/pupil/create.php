    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="active"><a href="index.php?s=admin/pupil/create">add pupil</a></li>
            </ul>
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="index.php?s=admin/pupil/create" method="post" class="form-horizontal" role="form">
